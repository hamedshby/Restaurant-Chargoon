namespace RestaurantChargoon.UI.WinForm.Forms.Foods
{
	partial class EditFoodForm
	{
		...
		private void InitializeComponent()
		{
			...
			label3.Location = new Point(241, 154);
			label3.Name = "label3";
			...
			// PricetextBox
			// 
			PricetextBox.Location = new Point(63, 82);
			...
			label2.Location = new Point(241, 87);
			label2.Name = "label2";
			...
			FoodTypeComboBox.Location = new Point(63, 151);
			...
			// SaveButton
			// 
			SaveButton.Location = new Point(63, 211);
			...
			// NameTextBox
			// 
			NameTextBox.Location = new Point(63, 27);
			...
			Name = "EditFoodForm";
			Text = "EditFoodForm";
			FormClosed += EditFoodForm_FormClosed;
