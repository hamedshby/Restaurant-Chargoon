    ...
    public class CartService
	{
		...
		public void Add(Cart newCart)
		{
			...
			else
			{
				...
				//var fdetail= cart.FactorDetails.FirstOrDefault(c => c.FoodId == factorDetail.FoodId);
				//if(fdetail != null)
				//{
				//	factorDetail.Id = fdid;
				//	factorDetail.Count += 1;
				//	cart.FactorDetails.Remove(fdetail);
				//}
